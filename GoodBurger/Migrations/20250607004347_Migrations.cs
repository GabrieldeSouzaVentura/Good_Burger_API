    ...
    public partial class Migrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExtrasExtraId = table.Column<int>(type: "INTEGER", nullable: false),
                    OrderId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraOrder", x => new { x.ExtrasExtraId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Burgers",
                columns: new[] { "BurgerId", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "X Burger", 5.0 },
                    { 2, "X Bacon", 7.0 },
            ...
            migrationBuilder.InsertData(
                table: "Extras",
                columns: new[] { "ExtraId", "Name", "Price" },
                values: new object[,]
                {
                    { 1, "French Fries", 2.0 },
                    { 2, "Soda", 2.5 }
